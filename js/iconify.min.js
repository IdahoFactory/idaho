...
var Iconify = function(e) {
	...
	function i(e, n, i) {
		...
		if (o)
			for (var a in t) void 0 === o[a] && void 0 !== e[a] && (o[a] = e[a]);
		return o && i ? r(o) : o
	}
	...
	function f(e) {
		...
		var r = e;
		if ("string" != typeof r.prefix || !e.icons || "object" != typeof e.icons) return null;
		for (var i in a)
			if (void 0 !== e[i] && typeof e[i] !== a[i]) return null;
		var o = r.icons;
		for (var c in o) {
			var f = o[c];
	...
	function p(e, n) {
		...
		var t = l[e];
		return void 0 === t[n] && (t[n] = function(e, n) {
			return {
				provider: e,
				prefix: n,
	...
	function m(e, n) {
		var t = [];
		return ("string" == typeof e ? [e] : Object.keys(l)).forEach((function(e) {
			("string" == typeof e && "string" == typeof n ? [n] : void 0 === l[e] ? [] : Object.keys(l[e])).forEach((function(n) {
				var r = p(e, n),
	...
	function x(e, n) {
		...
		return !!t && function(e, n, t) {
			try {
				if ("string" == typeof t.body) return e.icons[n] = Object.freeze(r(t)), !0
			} catch (e) {}
			return !1
	...
	function j(e, n) {
		...
		if ("string" != typeof n && (n = "string" == typeof e.provider ? e.provider : ""), y && "" === n && ("string" != typeof e.prefix || "" === e.prefix)) {
			var t = !1;
			return f(e) && (e.prefix = "", o(e, (function(e, n) {
				n && x(e, n) && (t = !0)
			}))), t
		}
		return !("string" != typeof e.prefix || !s({
			provider: n,
			prefix: e.prefix,
			name: "a"
		}) || !h(p(n, e.prefix), e))
		...
		for (var r in e) {
			...
			if (t[i] = e[i], void 0 !== n[i]) {
				...
				switch (i) {
					...
					case "width":
					case "height":
						("string" == typeof o && "" !== o || "number" == typeof o && o || null === o) && (t[i] = o);
						break;
					case "rotate":
	...
	function A(e, n, t) {
		if (1 === n) return e;
		if (t = void 0 === t ? 100 : t, "number" == typeof e) return Math.ceil(e * n * t) / t;
	...
	function T(e, n) {
		...
		[e, n].forEach((function(e) {
			var n, t = [],
				...
				a = e.vFlip,
				c = e.rotate;
			switch (r ? a ? c += 2 : (t.push("translate(" + (i.width + i.left).toString() + " " + (0 - i.top).toString() + ")"), t.push("scale(-1 1)"), i.top = i.left = 0) : a && (t.push("translate(" + (0 - i.left).toString() + " " + (i.height + i.top).toString() + ")"), t.push("scale(1 -1)"), i.top = i.left = 0), c < 0 && (c -= 4 * Math.floor(c / 4)), c %= 4) {
				case 1:
					n = i.height / 2 + i.top, t.unshift("rotate(90 " + n.toString() + " " + n.toString() + ")");
					break;
				case 2:
					t.unshift("rotate(180 " + (i.width / 2 + i.left).toString() + " " + (i.height / 2 + i.top).toString() + ")");
					break;
				case 3:
					n = i.width / 2 + i.left, t.unshift("rotate(-90 " + n.toString() + " " + n.toString() + ")")
			}
			c % 2 == 1 && (0 === i.left && 0 === i.top || (n = i.left, i.left = i.top, i.top = n), i.width !== i.height && (n = i.width, i.width = i.height, i.height = n)), t.length && (o = '<g transform="' + t.join(" ") + '">' + o + "</g>")
		})), null === n.width && null === n.height ? t = A(r = "1em", i.width / i.height) : null !== n.width && null !== n.height ? (t = n.width, r = n.height) : null !== n.height ? t = A(r = n.height, i.width / i.height) : r = A(t = n.width, i.height / i.width), "auto" === t && (t = i.width), "auto" === r && (r = i.height);
		var a = {
			attributes: {
				width: t = "string" == typeof t ? t : t.toString() + "",
				height: r = "string" == typeof r ? r : r.toString() + "",
				preserveAspectRatio: M(n),
				viewBox: i.left.toString() + " " + i.top.toString() + " " + i.width.toString() + " " + i.height.toString()
			},
			body: o
		};
	...
	var P = /\sid="(\S+)"/g,
		C = "IconifyId" + Date.now().toString(16) + (16777216 * Math.random() | 0).toString(16),
		_ = 0;
	...
	function D(e, n) {
		...
		return r.length ? (r.forEach((function(t) {
			var r = "function" == typeof n ? n(t) : n + (_++).toString(),
				i = t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
			e = e.replace(new RegExp('([#;"])(' + i + ')([")]|\\.[a-z])', "g"), "$1" + r + "$3")
		})), e) : e
	}
	var L = "iconify2",
		N = "iconify",
			...
			function t(n) {
				...
				if (t) {
					var r = function(n) {
						...
						try {
							var a = JSON.parse(i);
							o = !("object" != typeof a || "number" != typeof a.cached || a.cached < e || "string" != typeof a.provider || "object" != typeof a.data || "string" != typeof a.data.prefix) && h(p(a.provider, a.data.prefix), a.data).length > 0
						} catch (e) {
							o = !1
						}
					...
					try {
						var i = t.getItem(z);
						if (i !== L) return i && function(e) {
							try {
								for (var n = B(e), t = 0; t < n; t++) e.removeItem(N + t.toString())
							} catch (e) {}
						}(t), void
						function(e, n) {
							try {
						...
						for (var o = B(t), a = o - 1; a >= 0; a--) r(a) || (a === o - 1 ? o-- : V[n].push(a));
						J(t, n, o)
					} catch (e) {}
				}
			}
	...
	for (var te = Object.create(null), re = ["https://api.simplesvg.com", "https://api.unisvg.com"], ie = []; re.length > 0;) 1 === re.length || Math.random() > .5 ? ie.push(re.shift()) : ie.push(re.pop());
		...
		le = {
			prepare: function(e, n, t) {
				...
				return t.forEach((function(t, f) {
					(c += t.length + 1) >= i && f > 0 && (r.push(a), a = {
						type: o,
						provider: e,
						prefix: n,
						icons: []
					}, c = t.length), a.icons.push(t)
				})), r.push(a), r
			},
			send: function(e, n, t) {
				if (se) {
		...
		return {
			query: function(e, i, o) {
				var a = function(e, n, t, r) {
					...
					function m() {
						"pending" === l && (l = "aborted"), g(), p.forEach((function(e) {
					...
					return "function" == typeof r && h.push(r), setTimeout((function r() {
							if ("pending" === l) {
								g();
								var o = i.shift();
								if (void 0 === o) return p.length ? void(d = setTimeout((function() {
									g(), "pending" === l && (x(), b())
								}), e.timeout)) : void b();
								var a = {
									status: "pending",
									...
									callback: function(n, t) {
										! function(n, t, o) {
											...
											if ("abort" === t) return u = o, void b();
											if (a) return u = o, void(p.length || (i.length ? r() : b()));
											if (g(), x(), !e.random) {
												var c = e.resources.indexOf(n.resource); - 1 !== c && c !== e.index && (e.index = c)
											}
											l = "completed", h.forEach((function(e) {
												e(o)
											}))
										}(a, n, t)
									}
								};
								p.push(a), v++, d = setTimeout(r, e.rotate), t(o, n, a.callback)
							}
						})),
						function() {
							return {
	...
	function xe(e, n, t) {
		...
		return r && i ? r.query(n, i, t)().abort : (t(void 0, 424), ye)
	}
	...
	function ke(e, n, t) {
		...
		var i = Ie[e];
		void 0 === we[e] && (we[e] = Object.create(null));
		var o = we[e];
		void 0 === r[n] ? r[n] = t : r[n] = r[n].concat(t).sort(), i[n] || (i[n] = !0, setTimeout((function() {
			i[n] = !1;
			var t = r[n];
			delete r[n];
			var a = ee(e);
			a ? a.prepare(e, n, t).forEach((function(t) {
				xe(e, t, (function(r, i) {
					var a = p(e, n);
					if ("object" != typeof r) {
						if (404 !== i) return;
											...
											if (r.length) {
												...
												r.forEach((function(t) {
													...
													r.pending = r.pending.filter((function(t) {
														...
														var a = t.name;
														if (void 0 !== i.icons[a]) r.loaded.push({
															provider: e,
															prefix: n,
															name: a
														});
														...
														return !1
													})), r.pending.length !== a && (o || pe([{
														provider: e,
														prefix: n
													}], t.id), t.callback(r.loaded.slice(0), r.missing.slice(0), r.pending.slice(0), t.abort))
												}))
											}
										}
									})))
				...
				Se[t] < r && (Se[t] = r, console.error('Unable to retrieve icons for "' + t + '" because API is not configured properly.'))
			}()
		})))
	}
	var Ae = function(e) {
			var n = e.provider,
				t = e.prefix;
			return we[n] && we[n][t] && void 0 !== we[n][t][e.name]
		},
		Me = function(e, n) {
			var t = function(e) {
				var n = {
			...
			if (!t.pending.length) {
				...
				return n && setTimeout((function() {
						r && n(t.loaded, t.missing, t.pending, je)
					})),
					function() {
						r = !1
					}
			...
			t.pending.forEach((function(e) {
				...
				if (t !== o || n !== i) {
					i = n, o = t, c.push({
						provider: n,
						prefix: t
					}), void 0 === we[n] && (we[n] = Object.create(null));
					var r = we[n];
					void 0 === r[t] && (r[t] = Object.create(null)), void 0 === a[n] && (a[n] = Object.create(null));
					var f = a[n];
					void 0 === f[t] && (f[t] = [])
				}
			}));
			...
			return t.pending.forEach((function(e) {
				var n = e.provider,
					...
					r = e.name,
					i = we[n][t];
				void 0 === i[r] && (i[r] = f, a[n][t].push(r))
			})), c.forEach((function(e) {
				var n = e.provider,
					t = e.prefix;
				a[n][t].length && ke(n, t, a[n][t])
			})), n ? function(e, n, t) {
				var r = he++,
					i = pe.bind(null, t, r);
		...
		Fe = "iconifyFinder" + Date.now(),
		Pe = "iconifyData" + Date.now();
	...
	function Ce(e, n, t, r) {
		...
		var o = T(t, I(E, n)),
			...
			l = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--' + f.prefix + ("" === f.provider ? "" : " iconify--" + f.provider) + (s.length ? " " + s.join(" ") : "") + '">' + D(o.body) + "</svg>";
		i.innerHTML = l;
		...
		if (Object.keys(p).forEach((function(e) {
			...
			})), o.inline && (d.verticalAlign = "-0.125em"), a) {
			for (var h = a.attributes, g = 0; g < h.length; g++) {
				var m = h.item(g);
				if (m) {
					var y = m.name;
					if ("class" !== y && "style" !== y && void 0 === p[y]) try {
		...
		return a && a.parentNode ? a.parentNode.replaceChild(v, a) : i.removeChild(v), O
	}
	var _e = [];
	...
	function Le(e, n) {
		void 0 === n && (n = !1);
		var t = De(e);
		return t ? (t.temporary && (t.temporary = n), t) : (t = {
			node: e,
			temporary: n
		}, _e.push(t), t)
	}
		...
		if (e.observer) {
			...
			if (!t.pendingScan)
				for (var r = 0; r < n.length; r++) {
					var i = n[r];
					if (i.addedNodes && i.addedNodes.length > 0 || "attributes" === i.type && void 0 !== i.target[Fe]) return void(t.paused || Ue(e))
				}
		}
	}

	function $e(e, n) {
		e.observer.instance.observe(n, ze)
	}
	...
	function He(e) {
		...
		if (!n || !n.instance) {
			...
			t && (n || (n = {
				paused: 0
			}, e.observer = n), n.instance = new MutationObserver(qe.bind(null, e)), $e(e, t), n.paused || Ue(e))
		}
	}
	...
	function Ge(e) {
		(e ? [e] : Ne()).forEach((function(e) {
			if (e.observer) {
				var n = e.observer;
				n.paused++, n.paused > 1 || !n.instance || n.instance.disconnect()
			} else e.observer = {
				paused: 1
			}
		}))
				...
				(function(e) {
					...
					return Array.prototype.forEach.call(t, (function(e) {
						...
						if (r && i) {
							...
							if (null !== o) {
								var a, c = !1;
								if (o.prefix !== i.name.prefix || o.name !== i.name.name ? c = !0 : (a = r.customisations(t), function(e, n) {
										var t = Object.keys(e),
											r = Object.keys(n);
					...
					var r, a, c = n.element,
						...
						l = f.name,
						v = c[Pe];
					if (void 0 !== v && (a = f, null !== (r = v.name) && null !== a && r.name === a.name && r.prefix === a.prefix)) switch (v.status) {
						case "missing":
							return;
						case "loading":
							if (Ae({
					...
					if (void 0 === d.icons[l]) {
						...
						!o && e.observer && (Ge(e), o = !0);
						var m = void 0 !== n.customisations ? n.customisations : n.finder.customisations(c);
						Ce(n, m, g(d, l))
					}
				})), e.temporary && !i ? We(r) : n && i ? Ke(r, !0) : o && e.observer && Be(e)
			}
		})), Object.keys(t).forEach((function(e) {
			var n = t[e];
			Object.keys(n).forEach((function(t) {
				Me(Object.keys(n[t]).map((function(n) {
					return {
						provider: e,
						prefix: t,
						name: n
	...
	var cn = ["inline", "hFlip", "vFlip"],
		...
		un = {
			...
			name: function(e) {
				return on(e, "data-icon") ? an(e, "data-icon") : null
			},
			customisations: function(e, n) {
				...
				if (-1 !== (i ? i.split(/\s+/) : []).indexOf("iconify-inline") && (r.inline = !0), on(e, "data-rotate")) {
					var o = function(e, n) {
						void 0 === n && (n = 0);
						var t = e.replace(/^-?[0-9.]*/, "");
				...
				return on(e, "data-flip") && (t = r, an(e, "data-flip").split(rn).forEach((function(e) {
					switch (e.trim()) {
						case "horizontal":
							t.hFlip = !0;
							break;
				...
				}))), on(e, "data-align") && function(e, n) {
					n.split(rn).forEach((function(n) {
						var t = n.trim();
						switch (t) {
							case "left":
							case "center":
				...
				}(r, an(e, "data-align")), cn.forEach((function(n) {
					if (on(e, "data-" + n)) {
						var t = function(e, n) {
	...
	function sn(e, n, t) {
		...
		return r ? Ce({
			name: u(e)
		}, I(E, "object" == typeof n ? n : {}), r, t) : null
	}
	...
	if ("undefined" != typeof document && "undefined" != typeof window) {
		! function() {
			if (document.documentElement) return Le(document.documentElement);
			_e.push({
				node: function() {
		...
		function(e) {
			-1 === Xe.indexOf(e) && Xe.push(e)
		}(un);
		var gn = window;
		if (void 0 !== gn.IconifyPreload) {
			var mn = gn.IconifyPreload,
				yn = "Invalid IconifyPreload syntax.";
			"object" == typeof mn && null !== mn && (mn instanceof Array ? mn : [mn]).forEach((function(e) {
				try {
					("object" != typeof e || null === e || e instanceof Array || "object" != typeof e.icons || "string" != typeof e.prefix || !j(e)) && console.error(yn)
				} catch (e) {
					console.error(yn)
				}
			}))
		...
		setTimeout((function() {
			(function(e) {
				var n = null !== Re;
				Re !== e && (Re = e, n && Ne().forEach(Ye)), n ? Ve() : function(e) {
					var n = document;
	...
	if (Z("", le), "undefined" != typeof document && "undefined" != typeof window) {
		K.store = function(e, n) {
			...
			$ || Q(), Object.keys(n.icons).length && (n.not_found && delete(n = Object.assign({}, n)).not_found, t("local") || t("session"))
		}, Q();
		var jn = window;
		if (void 0 !== jn.IconifyProviders) {
			var wn = jn.IconifyProviders;
			if ("object" == typeof wn && null !== wn)
				for (var On in wn) {
					var En = "IconifyProviders[" + On + "] is invalid.";
					try {
						var In = wn[On];
						if ("object" != typeof In || !In || void 0 === In.resources) continue;
						oe(On, In) || console.error(En)
					} catch (e) {
						console.error(En)
					}
				}
	...
	return e._api = Sn, e.addAPIProvider = oe, e.addCollection = j, e.addIcon = x, e.buildIcon = F, e.calculateSize = A, e.default = kn, e.disableCache = xn, e.enableCache = bn, e.getIcon = O, e.getVersion = ln, e.iconExists = w, e.listIcons = m, e.loadIcon = Te, e.loadIcons = Me, e.observe = Ke, e.pauseObserver = Je, e.renderHTML = dn, e.renderIcon = pn, e.renderSVG = vn, e.replaceIDs = D, e.resumeObserver = Qe, e.scan = hn, e.shareStorage = d, e.stopObserving = We, Object.defineProperty(e, "__esModule", {
		value: !0
	}), e
}({});
