...
! function(t, e) {
	...
	function $(t) {
		...
		return i(s) ? p = _ = {
			...
			function(t, i, n) {
				var o, h, c, d, m, g, v, y, T, w = (n || e).length,
					b = u[w];
				if (!b) {
	...
	function at(t, e, r) {
		...
		if (!c) {
			if ("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), ke[t]) c = ke[t];
				...
				} else o = +c[0] % 360 / 360, u = c[1] / 100, i = 2 * (h = c[2] / 100) - (n = h <= .5 ? h * (u + 1) : h + u - h * u), 3 < c.length && (c[3] *= 1), c[0] = st(o + 1 / 3, i, n), c[1] = st(o, i, n), c[2] = st(o - 1 / 3, i, n);
	...
	function ut(t, e, r) {
		...
		if (u = u.map((function(t) {
			...
			for (a = (n = t.replace(Ae, "1").split(ee)).length - 1; f < a; f++) o += n[f] + (~i.indexOf(f) ? u.shift() || h + "0,0,0,0)" : (s.length ? s : u.length ? u : r).shift());
		if (!n)
			for (a = (n = t.split(Ae)).length - 1; f < a; f++) o += n[f] + u[f];
		return o + n[a]
	}
	...
	var dt, mt, gt, vt, yt, Tt, xt, wt, bt, Mt, Ot, kt, At, Ct, Dt, Pt, St, zt, Rt, Et, Ft, Bt, It, Lt, Yt, Ut, Xt = {
			autoSleep: 120,
			force3D: "auto",
			nullTargetWarn: 1,
			units: {
		...
		Ce = /hsl[a]?\(/,
		De = (St = Date.now, zt = 500, Rt = 33, Et = St(), Ft = Et, It = Bt = 1e3 / 240, Ct = {
			time: 0,
			frame: 0,
			tick: function() {
				Be(!0)
	...
	function Be(t) {
		var e, r, i, n, s = St() - Ft,
			a = !0 === t;
		if (zt < s && (Et += s - Rt), (0 < (e = (i = (Ft += s) - Et) - It) || a) && (n = ++Ct.frame, Dt = i - 1e3 * Ct.time, Ct.time = i /= 1e3, It += e + (Bt <= e ? 4 : Bt - e), r = 1), a || (Ot = kt(Be)), r)
	...
	var Le, Ye = function(t, e) {
		...
		Ue = ((Le = Xe.prototype).delay = function(t) {
			...
			return this._rts = +t || 0, this._ts = this._ps || t === -Vt ? 0 : this._rts, this.totalTime(Te(-this._delay, this._tDur, e), !0), L(this),
				function(t) {
	...
	var Ne = function(t) {
		...
		return o.to = function(t, e, r) {
			...
			var i, n, s, a, o, u, h, f, l, p, _, c, d = this._time,
	...
	function qe(t, e, r, s, a, u) {
		...
		if (fe[t] && !1 !== (h = new fe[t]).init(a, h.rawVars ? e[t] : function(t, e, r, s, a) {
				...
				return h
			}(e[t], s, a, u, r), r, s, u) && (r._pt = f = new pr(r._pt, a, t, 0, 1, h.render, h, 0, h.priority), r !== bt))
	...
	var je, Qe, Ge = function(t, e, r, s, a, o, u, h, f) {
			...
			if (i(s) && (~s.indexOf("random(") && (s = rt(s)), "=" === s.charAt(1) && (!(l = w(c, s) + (W(c) || 0)) && 0 !== l || (s = l))), c !== s || Qe) return isNaN(c * s) || "" === s ? (_ || e in t || p(e, s), function(t, e, r, i, n, s, a) {
				var o, u, h, f, l, p, _, c, d = new pr(this._pt, t, e, 0, 1, or, null, n),
					m = 0,
					g = 0;
		...
		We = function t(e, r) {
			var i, n, s, a, o, h, f, l, p, _, c, d, v, y = e.vars,
				T = y.ease,
				x = y.startAt,
				w = y.immediateRender,
				b = y.lazy,
			...
			if (!X || z && T || (T = "none"), e._ease = Fe(T, Nt.ease), e._yEase = S ? Ee(Fe(!0 === S ? T : S, Nt.ease)) : 0, S && e._yoyo && !e._repeat && (S = e._yEase, e._yEase = e._ease, e._ease = S), e._from = !X && !!y.runBackwards, !X || z && !y.stagger) {
				if (d = (l = I[0] ? g(I[0]).harness : 0) && y[l.prop], i = P(y, oe), B && (E(B.render(-1, !0)), B._lazy = 0), x)
					if (E(e._startAt = Je.set(I, C({
							data: "isStart",
							overwrite: !1,
							parent: L,
							immediateRender: !0,
				...
				for (e._pt = e._ptCache = 0, b = F && u(b) || b && !F, n = 0; n < I.length; n++) {
					if (f = (o = I[n])._gsap || m(I)[n]._gsap, e._ptLookup[n] = _ = {}, he[f.id] && ue.length && M(), c = Y === I ? n : Y.indexOf(o), l && !1 !== (p = new l).init(o, d || i, e, c, Y) && (e._pt = a = new pr(e._pt, o, p.name, 0, 1, p.render, p, 0, p.priority), p._props.forEach((function(t) {
						...
						for (s in i) fe[s] && (p = qe(s, i, e, c, o, Y)) ? p.priority && (h = 1) : _[s] = a = Ge.call(e, o, s, "get", i[s], c, Y, 0, y.stringFilter);
		...
		Ze = ce + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
		$e = {};
	...
	var Je = function(t) {
		function n(e, i, n, a) {
			...
			var l, p, c, d, g, v, y, T, w = (h = t.call(this, a ? i : S(i)) || this).vars,
				b = w.duration,
				M = w.delay,
				O = w.immediateRender,
				k = w.stagger,
			...
			if (h._targets = B.length ? m(B) : _("GSAP target " + e + " not found. https://greensock.com", !Xt.nullTargetWarn) || [], h._ptLookup = [], h._overwrite = A, D || k || f(b) || f(M)) {
				if (i = h.vars, (l = h.timeline = new Ne({
					...
					if (d = B.length, y = k && $(k), o(k))
						for (g in k) ~Ze.indexOf(g) && ((T = T || {})[g] = k[g]);
		...
		return a.render = function(t, e, r) {
			...
			return this._initted || We(this, n),
			...
			for (n = this._op = this._op || [], "all" !== e && (i(e) && (u = {}, y(e, (function(t) {
				...
				if (~p.indexOf(l[f]))
					for (u in s = _[f], "all" === e ? (n[f] = e, o = s, a = {}) : (a = n[f] = n[f] || {}, o = e), o)(h = s && s[u]) && ("kill" in h.d && !0 !== h.d.kill(u) || R(this, h, "_pt"), delete s[u]), "all" !== a && (a[u] = 1);
	...
	var cr = {
		...
		utils: {
			...
			toArray: we,
			selector: function(t) {
				return t = we(t)[0] || _("Invalid scope") || {},
					function(e) {
			...
			init: function(t, r, n) {
				n._onInit = function(t) {
					...
					if (i(r) && (n = {}, y(r, (function(t) {
						...
						for (r in e)
							for (i = s.length; i--;)(n = (n = t._ptLookup[i][r]) && n.d) && (n._pt && (n = dr(n, r)), n && n.modifier && n.modifier(e[r], t, s[i], r))
					}(t, r)
				}
			}
		}
	...
	function zr() {
		"undefined" != typeof window && window.document && (Jr = window, Kr = Jr.document, ti = Kr.documentElement, ri = Pr("div") || {
			style: {}
		}, Pr("div"), Si = Ei(Si), zi = Si + "Origin", ri.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", ni = !!Ei("perspective"), ei = 1)
	}
	...
	function Xr(t, e, r, i) {
		...
		var a, o, u, h, f, l, p, _, c, d, m, g = new pr(this._pt, t.style, e, 0, 1, or),
			v = 0,
			y = 0;
	...
	function qr(t, e) {
		if (e.tween && e.tween._time === e.tween._dur) {
			...
			if ("all" === o || !0 === o) a.cssText = "", i = 1;
				...
				for (n = (o = o.split(",")).length; - 1 < --n;) r = o[n], bi[r] && (i = 1, r = "transformOrigin" === r ? zi : Si), Ir(s, r);
	...
	function Hr(t, e, r, n, s) {
		var a, o, u = 360,
			h = i(s),
			f = parseFloat(s) * (h && ~s.indexOf("rad") ? Mi : 1) - n,
			l = n + f + "deg";
	...
	function $r(t, e, r) {
		var i, n, s, a, o, u, h, f = Zr({}, r._gsap),
			l = r.style;
	...
	var Jr, Kr, ti, ei, ri, ii, ni, si = Se.Power0,
		ai = Se.Power1,
		oi = Se.Power2,
		ui = Se.Power3,
		hi = Se.Power4,
	...
	var Wi, Hi, Zi = {
		...
		init: function(t, e, r, n, s) {
			var a, o, u, h, f, l, _, c, d, m, g, v, y, T, x, b = this._props,
				M = t.style,
				O = r.vars.startAt;
			for (_ in ei || zr(), e)
				if ("autoRound" !== _ && (o = e[_], !fe[_] || !qe(_, e, r, n, t, s)))
					if (f = typeof o, l = Ii[_], "function" === f && (f = typeof(o = o.call(r, n, t, s))), "string" === f && ~o.indexOf("random(") && (o = rt(o)), l) l(this, t, _, o, r) && (x = 1);
					else if ("--" === _.substr(0, 2)) a = (getComputedStyle(t).getPropertyValue(_) + "").trim(), o += "", Ae.lastIndex = 0, Ae.test(a) || (c = W(a), d = W(o)), d ? c !== d && (a = Yr(t, _, a, d) + d) : c && (o += c), this.add(M, "setProperty", a, o, n, s, 0, 0, _), b.push(_);
			else if ("undefined" !== f) {
				if (O && _ in O ? (i(a = "function" == typeof O[_] ? O[_].call(r, n, t, s) : O[_]) && ~a.indexOf("random(") && (a = rt(a)), W(a + "") || (a += Xt.units[_] || W(Ur(t, _)) || ""), "=" === (a + "").charAt(1) && (a = Ur(t, _))) : a = Ur(t, _), h = parseFloat(a), (m = "string" === f && "=" === o.charAt(1) && o.substr(0, 2)) && (o = o.substr(2)), u = parseFloat(o), _ in Pi && ("autoAlpha" === _ && (1 === h && "hidden" === Ur(t, "visibility") && u && (h = 0), Lr(this, M, "visibility", h ? "inherit" : "hidden", u ? "inherit" : "hidden", !u)), "scale" !== _ && "transform" !== _ && ~(_ = Pi[_]).indexOf(",") && (_ = _.split(",")[0])), g = _ in bi)
					if (v || ((y = t._gsap).renderTransform && !e.parseTransform || Ui(t, e.parseTransform), T = !1 !== e.smoothOrigin && y.smooth, (v = this._pt = new pr(this._pt, M, Si, 0, 1, y.renderTransform, y, 0, -1)).dep = 1), "scale" === _) this._pt = new pr(this._pt, y, "scaleY", y.scaleY, (m ? w(y.scaleY, m + u) : u) - y.scaleY || 0), b.push("scaleY", _), _ += "X";
					else {
				...
				if (g || (u || 0 === u) && (h || 0 === h) && !Di.test(o) && _ in M) u = u || 0, (c = (a + "").substr((h + "").length)) !== (d = W(o) || (_ in Xt.units ? Xt.units[_] : c)) && (h = Yr(t, _, a, d)), this._pt = new pr(this._pt, g ? y : M, _, h, (m ? w(h, m + u) : u) - h, g || "px" !== d && "zIndex" !== _ || !1 === e.autoRound ? vr : xr), this._pt.u = d || 0, c !== d && "%" !== d && (this._pt.b = a, this._pt.r = Tr);
				else if (_ in M) Xr.call(this, t, _, a, m ? m + o : o);
				else {
					if (!(_ in t)) {
						p(_, o);
						continue
